  ...
  a: {
    ...
    preAtivacao: [
      { id: 'pre_a1', label: 'Clamshell 15/lado',
        como: 'De lado, joelhos dobrados e colados, abre o joelho de cima mantendo os pés juntos, sem rodar o tronco para trás.',
        porq: 'Acende o glúteo médio antes de carregar peso — sem isso o quadril cai e o joelho fica vulnerável nos exercícios seguintes.' },
      { id: 'pre_a2', label: 'Ponte unilateral 10/lado',
        como: 'Deitada, um pé apoiado no chão e a outra perna estendida no ar. Sobe o quadril usando só o glúteo de apoio.',
        porq: 'Prepara o padrão de extensão de quadril unilateral que vai ser exigido no Deadlift romeno e no Stiff.' },
    ],
    exercicios: [
      { id: 'a1', label: 'Ponte glútea com barra',       volume: '4×12', priority: 'Prioridade',
        ...
        porq: 'Principal exercício pra fortalecer o glúteo máximo, que está fraco e sobrecarregando a lombar nas suas atividades.',
      ...
      { id: 'a2', label: 'Deadlift romeno',              volume: '4×10', priority: 'Prioridade',
        ...
        porq: 'Fortalece a cadeia posterior e ensina a flexionar o quadril sem perder a lombar neutra — a postura que você usa correndo.',
      ...
      { id: 'a3', label: 'Agachamento búlgaro',          volume: '3×10/lado', priority: 'Alto',
        ...
        porq: 'Unilateral — corrige a assimetria entre as pernas e exige estabilidade de quadril, ponto fraco identificado na avaliação.',
      ...
      { id: 'a4', label: 'Abdução cabo em pé — glúteo médio', volume: '3×15/lado', priority: 'Alto',
        ...
        porq: 'Isola o glúteo médio, o principal responsável por evitar que o joelho caia para dentro ao correr.',
      ...
      { id: 'a5', label: 'Stiff unilateral',             volume: '3×10/lado', priority: 'Alto',
        ...
        porq: 'Reforça o lado mais fraco isoladamente, sem o lado dominante compensar e mascarar a diferença.',
      ...
      { id: 'a6', label: 'Leg curl deitado',             volume: '3×12', priority: 'Complementar',
        ...
        porq: 'Fortalece os isquiotibiais, parte da cadeia posterior encurtada que puxa a pelve.' },
      { id: 'a7', label: 'Dead bug — finalização',       volume: '3×8/lado', priority: 'Finalização',
        ...
        porq: 'Fecha o treino estabilizando o core, pra proteger a lombar nos próximos dias de treino.',
  ...
  b: {
    ...
    preAtivacao: [
      { id: 'pre_b1', label: 'Dead bug 8/lado',
        como: 'Deitada, braços e pernas a 90°. Estende um braço e a perna oposta ao mesmo tempo, lombar sempre colada no chão.',
        porq: 'Liga o core antes do agachamento — sem isso a lombar compensa e tira a carga do lugar certo.' },
      { id: 'pre_b2', label: 'Monster walk 10/lado',
        como: 'Elástico nos tornozelos, levemente agachada, dá passos largos para o lado mantendo a tensão constante no elástico.',
        porq: 'Ativa o glúteo médio pra evitar que o joelho caia para dentro (valgo) nos agachamentos e no leg press.' },
    ],
    exercicios: [
      { id: 'b1', label: 'Agachamento livre',            volume: '4×10', priority: 'Prioridade',
        ...
        porq: 'Base do treino de quadríceps — fortalece a perna toda, com atenção pro joelho não cair pra dentro.',
      ...
      { id: 'b2', label: 'Leg press 45°',               volume: '4×12', priority: 'Prioridade',
        ...
        porq: 'Permite carga alta com menos exigência de equilíbrio, bom pra ganhar força sem comprometer a técnica.',
      ...
      { id: 'b3', label: 'Agachamento sumô com haltere', volume: '3×12', priority: 'Alto',
        ...
        porq: 'Trabalha os adutores encurtados e abre o quadril, ajudando a destravar a rotação interna do fêmur.',
      ...
      { id: 'b4', label: 'Afundo caminhando',           volume: '3×10/lado', priority: 'Alto',
        ...
        porq: 'Unilateral — mostra e corrige a diferença de força entre as pernas durante o movimento.',
      ...
      { id: 'b5', label: 'Cadeira extensora',           volume: '3×15', priority: 'Complementar',
        ...
        porq: 'Isola o quadríceps, em especial o VMO, que ajuda a estabilizar o joelho.' },
      { id: 'b6', label: 'Panturrilha em pé',           volume: '4×15', priority: 'Complementar',
        ...
        porq: 'A panturrilha está com encurtamento severo nos dois lados — fortalecer em amplitude ajuda a soltar.',
      ...
      { id: 'b7', label: 'Prancha com respiração',      volume: '3×25 seg', priority: 'Finalização',
        ...
        porq: 'Fecha o treino com estabilização do core, sem prender a respiração — ensina o padrão certo de ativação.' },
    ]
  },
  c: {
    ...
    preAtivacao: [
      { id: 'pre_c1', label: 'Band pull-apart 15',
        como: 'Elástico nas duas mãos, na altura do peito, afasta os braços abrindo o peito até as escápulas se encontrarem.',
        porq: 'Pré-ativa os romboides — combate o ombro enrolado antes da remada e do face pull.' },
      { id: 'pre_c2', label: 'Face pull elástico 15',
        como: 'Elástico na altura do rosto, puxa em direção à testa com os cotovelos altos, terminando com rotação externa.',
        porq: 'Mesmo padrão do exercício principal, em carga leve — aquece o manguito rotador e a parte de trás do ombro.' },
      { id: 'pre_c3', label: 'Deep neck flexor 10×5 seg',
        como: 'Deitada, faz um leve chin tuck (queixo pra trás) e segura 5 segundos sem tirar a cabeça do chão.',
        porq: 'Cabeça anteriorizada sobrecarrega o pescoço — isso liga os estabilizadores profundos antes do treino de costas.' },
    ],
    exercicios: [
      { id: 'c1', label: 'Remada curvada com barra',    volume: '4×10', priority: 'Prioridade',
        ...
        porq: 'Fortalece a parte de trás do ombro e das costas pra contrabalançar a postura de ombros enrolados.',
      ...
      { id: 'c2', label: 'Face pull com corda',         volume: '4×15', priority: 'Prioridade',
        ...
        porq: 'Trabalha rotação externa e retração de escápula — o oposto direto do padrão de ombro projetado pra frente.',
      ...
      { id: 'c3', label: 'Puxada (lat pulldown) — pegada média', volume: '4×10', priority: 'Alto',
        ...
        porq: 'Fortalece o grande dorsal e ajuda a manter a postura de ombro sem sobrecarregar a cervical.',
      ...
      { id: 'c4', label: 'Desenvolvimento com halteres', volume: '3×10', priority: 'Alto',
        ...
        porq: 'Fortalece o ombro em amplitude segura, sem compensar com a lombar.',
      ...
      { id: 'c5', label: 'Rosca direta',                volume: '3×12', priority: 'Complementar',
        ...
        porq: 'Exercício complementar pra equilíbrio muscular do braço, sem relação direta com o quadro postural.',
      ...
      { id: 'c6', label: 'Tríceps corda',               volume: '3×12', priority: 'Complementar',
        ...
        porq: 'Complementar — fecha o equilíbrio do braço sem exigir nada da postura.',
      ...
      { id: 'c7', label: 'Band pull-apart — finalização', volume: '3×15', priority: 'Finalização',
        ...
        porq: 'Fecha o treino reforçando a retração de escápula — o padrão que você precisa repetir o dia todo.',
